...
<head>
  ...
  <style>
    ...
    .nav a { background:#0d6efd; color:#fff; text-decoration:none; padding:8px 16px; border-radius:4px; font-size:14px; font-weight:bold; }
...
<div class="container">
    <div class="nav">
        <a href="index.php">← Kembali ke Analisis Chart</a>
    </div>
    ...
    <div class="grid">
        ...
        <div class="panel">
            ...
            <table>
                ...
                <tr>
                    <td><strong><a href="index.php?symbol=<?= urlencode($s['symbol']) ?>" target="_blank" style="text-decoration:none; color:#198754;"><?= $s['symbol'] ?></a></strong></td>
        ...
        <div class="panel">
            ...
            <table>
                ...
                <tr>
                    <td><strong><a href="index.php?symbol=<?= urlencode($s['symbol']) ?>" target="_blank" style="text-decoration:none; color:#dc3545;"><?= $s['symbol'] ?></a></strong></td>
                    <td class="text-right"><?= number_format($s['close']) ?></td>
        ...
        <div class="panel full-width" style="border: 2px solid #0d6efd;">
            ...
            <table>
                ...
                <tr>
                    <td><strong><a href="index.php?symbol=<?= urlencode($s['symbol']) ?>" target="_blank" style="text-decoration:none; color:#0d6efd;"><?= $s['symbol'] ?></a></strong></td>
                    <td><?= $s['name'] ?></td>
                    <td class="text-right"><?= number_format($s['close']) ?></td>
